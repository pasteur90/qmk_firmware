...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [0] = LAYOUT_ortho_3x10(
    TD(TD_Q_TAB),    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,  FN6_P,
  ...
  [6] = LAYOUT_ortho_3x10(
    _______, KC_WH_L, KC_MS_U, KC_WH_R, KC_WH_U, _______, KC_MUTE, KC_VOLD, KC_VOLU, _______,
    _______, KC_MS_L, KC_MS_D, KC_MS_R, KC_WH_D, KC_MPRV, KC_MPLY, KC_MSTP, KC_MNXT, _______,
    _______, _______, _______, KC_BTN2, KC_BTN1, KC_BTN3, _______, _______, _______, _______
  ),
};
